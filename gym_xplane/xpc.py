...
class XPlaneConnect():
    ...
    # Basic Functions
    # def __init__(self, clientAddr, xpHost, xpPort, clientPort, timeout, max_episode_steps):
    def __init__(self, clientAddr='0.0.0.0', xpHost='127.0.0.1', xpPort=49009, clientPort=0, timeout=3000 ,max_episode_steps=303):
